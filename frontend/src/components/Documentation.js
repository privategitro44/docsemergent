...
import ArticleContent, { StepsBlock, IntegrationsBlock, ArticleLinksBlock, AccordionBlock } from "./ArticleContent";
...
const Documentation = () => {
  ...
  return (
    <div className="docs-layout" data-testid="docs-layout">
      ...
      <div ref={supportRef} className={`supporting-header mobile-only ${scrolled ? 'glass' : ''}`} style={{position:'sticky'}}>
          ...
          {currentArticle && (
            <div className="article-footer">
              ...
              <div className="social-links" id="social-links">
                {(() => {
                  const fixedLinks = [
                    { id: 'discord', label: 'Discord', icon: 'discord', url: 'https://discord.gg/VzKfwCXC4A' },
                    { id: 'x', label: 'X', icon: 'x', url: 'https://x.com/EmergentLabsHQ/' },
                    { id: 'linkedin', label: 'LinkedIn', icon: 'linkedin', url: 'https://www.linkedin.com/company/emergentlabs/' },
                    { id: 'instagram', label: 'Instagram', icon: 'instagram', url: 'https://www.instagram.com/emergentlabs/' }
                  ];
